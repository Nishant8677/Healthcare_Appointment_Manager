...
> **Status: Phase 6 complete** — booking with proven double-booking prevention, a
> transactional notification outbox, the doctor-leave cascade, and AI pre-visit and post-visit
> summaries that degrade safely when the model is unavailable. See [Roadmap](#roadmap).
